  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-8">
        ...
        <form action={saveResume} className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="specialties" className={label}>희망 진료과/부서 <span className="text-slate-400">(쉼표 구분)</span></label>
            <input id="specialties" name="specialties" defaultValue={r?.specialties?.join(", ") ?? ""} placeholder="예: 중환자실, 응급실" className={field} />
          </div>
          <div className="flex flex-col gap-1">
