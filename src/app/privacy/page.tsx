        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-slate-700">
          <section>
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>간호사 회원: 이력서 정보(이름, 연락처, 이메일, 거주지역, 성별·생년월일(선택), 면허 구분·취득연도·신고 여부, 보유 자격증, 전문간호사 분야, 학력·졸업 여부, 신규/경력 구분, 경력 상세(병원명·의료기관 종별·병상수·부서·재직기간·직위·담당업무), 간호간병통합병동 경력·차지 가능 여부, 희망 근무형태·야간전담 가능·희망 근무지·희망 진료과·희망 의료기관 종별·희망 고용형태·희망 급여·입사 가능일·기숙사 필요 여부, 자기소개)</li>
