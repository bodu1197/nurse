  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <a
        ...
        className="flex h-12 items-center justify-center gap-2 rounded-xl bg-[#03C75A] font-semibold text-white transition hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2"
      >
