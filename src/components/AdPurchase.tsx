...
export default function AdPurchase({ jobId, initialWeeks = 1, adCash, impCode, pg }: Readonly<{ jobId: string; initialWeeks?: number; adCash: number; impCode: string; pg: string }>) {
