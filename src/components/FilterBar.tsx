...
const selectClass =
  "h-11 rounded-[12px] border border-slate-300 bg-white px-3.5 text-sm text-slate-700 outline-none hover:border-slate-400 focus-visible:ring-2 focus-visible:ring-teal-600";
