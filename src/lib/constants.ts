...
//  · /talent — **색인한다**(오너 지시 2026-08-08, 2026-08-06 의 noindex 를 되돌림). 여기에 적지 않는 이유는
//    목록·상세를 app/sitemap.ts 가 lastModified 와 함께 따로 싣기 때문이다(공고와 같은 방식).
//    근거: 이름·연락처·사진은 광고 중인 병원에만 붙고 나머지는 서버에서 마스킹돼 나간다.
